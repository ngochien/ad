...
public class RunTimeTest {
	...
	public static void main(String[] args) {
		// nicht von der Anzahl der Schl¨ ussel-Wert-Paare abh¨ angt
...
//			System.out.println(numOfPairs + " - " + (end - start));
		}

		// // sondern von dem Verh¨ altnis <Anzahl Schl¨ usselWert-Paare>/<L¨
		// ange des Hash-Arrays>
		// for (int numOfPairs = 100; numOfPairs < 1_00_00_000; numOfPairs *=
		// 10) {
		//
		// int sizes = 100;
